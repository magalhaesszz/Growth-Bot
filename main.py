...
async def _restore_sessions():
    """
    Ao iniciar (ou reiniciar pelo Discloud), restaura sessões do Supabase
    para /tmp — já que o filesystem efêmero é limpo a cada deploy/restart.
    """
    try:
...
async def post_init(app: Application):
    ...
    scheduler.start()
    logger.info("Agendador iniciado com todos os jobs.")
    ...
    try:
        await app.bot.send_message(
            ...
            text=(
                "✅ *Growth Bot online!*\n"
                "Todos os módulos carregados e sessões restauradas.\n"
...
def main():
    ...
    logger.info("Bot rodando. Aguardando comandos no Telegram...")
